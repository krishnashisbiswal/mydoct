...
urlpatterns = [
    ...
    path('staff/edit/<int:staff_id>/', views.edit_staff, name='edit_staff'),  # Added URL for edit_staff
    path('staff/delete/<int:staff_id>/', views.delete_staff, name='delete_staff'),  # Added URL for delete_staff
